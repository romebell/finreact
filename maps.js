...
const googleKey = 'AIzaSyAjeovgum9MfDpwphmLfDvn9DAptoR-6XY';
const googleUrl = `https://maps.googleapis.com/maps/api/js?key=${googleKey}&callback=initMap`;
...
// dynamicallyLoadScript(googleUrl);
